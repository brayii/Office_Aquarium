...
You do not control individual employees. You lead through decisions, priorities, hiring approval, project direction, culture, and crisis response.

---

# 1. How to Think About the Game

Office Aquarium is not about clicking workers and telling them what to do.

Think like a CEO:

- Watch the organization.
- Read the signals.
- Decide which problems deserve executive attention.
- Balance cash, quality, people, customers, and speed.
- Learn from the consequences of earlier decisions.

A quiet inbox does not mean nothing is happening. It often means the company is handling work locally.
...
Loads the company saved on this device.

## Start New Company

Starts over with a new company, new employee relationships, and fresh conditions.

Starting a new company replaces the existing saved company after confirmation.
...
2. Let the simulation run at 1x speed.
3. Watch employees move through the office.
4. Open the Employees screen and inspect a few people.
5. Check the Company screen.
6. Read Department Briefings and the Project Portfolio.
7. Wait for your first CEO email or memo.
8. Read the message before choosing.
9. Pick one of the three responses.
10. Let time pass and watch what changes.
11. Read the weekly newspaper after it publishes.
12. Look for cause and effect between decisions and later outcomes.

Do not rush to fix every number. The company is supposed to breathe.
...
- who is writing
- what project or department is involved
- why the issue reached the CEO
- what evidence is available
- what different departments think
- what could improve
...
# 6. Reading CEO Emails and Memos

Every CEO message should answer four questions:

1. What is happening?
2. Why does this need the CEO?
3. What are the trade-offs?
4. What happens if I choose each option?

The best choice depends on the situation. A decision that helps one company may hurt another.

When reading a memo, look for:
...
Departments may disagree because they care about different things.

---

# 7. Department Viewpoints

## Engineering

Cares about feasibility, defects, integration, staffing, technical risk, and realistic schedules.

## Product

Cares about customers, roadmap, scope, timing, and whether the product solves the right problem.

## Finance

Cares about cash, runway, spending, return, and downside risk.

## People

Cares about workload, burnout, retention, hiring, fairness, and management capacity.

## Quality

Cares about testing, verification, reliability, defects, and rework.

## Operations

Cares about delivery, manufacturing, support, capacity, and continuity.

## Customer Success

Cares about customer trust, renewals, churn, support burden, and account health.

## Board

Cares about leadership credibility, governance, long-term value, investor confidence, and company survival.

---

# 8. Understanding Company Metrics

## Cash

Money available to pay for payroll, projects, hiring, support, manufacturing, and crisis response.

## Runway

How long the company can keep operating at its current cash-flow rate.

## Board Confidence

How much the Board trusts your leadership.

## Company Risk

A summary of overall danger across finance, projects, customers, staffing, operations, leadership, and strategy.

## Morale

How employees feel about working at the company.

## Trust

How much customers and the public trust the company.

## Customers

Active customer organizations using or paying for company products.

## Customer Sentiment

How customers currently feel about the company and its products.

## Daily Revenue

Revenue currently generated each day by customers and commercial products.

## Investor Confidence

How outside investors view the company's future.

## Manufacturing

How ready and reliable the company is at building and delivering physical products.
...
Projects drive much of the company.
...
Progress alone is not enough. A project can be 100% complete and still have weak commercial value, poor quality, or low customer demand.
...
Hiring is usually created by real pressure:
...
Employees can become overloaded.

Sustained stress may lead to:
...
One stressful day is not always a crisis. A long pattern is more dangerous.

---

# 12. Customers and Revenue

Customers may adopt, wait, expand, complain, renew, reduce usage, or leave.

Customer behavior depends on product quality, trust, support, pricing, reliability, roadmap confidence, and company stability.

Revenue usually comes from commercial products and customers. A completed project may still need customer adoption or a commercial path before it produces meaningful revenue.

---

# 13. Learning and Company Memory

The company learns from outcomes over time.
...
Employees, managers, customers, investors, the Board, and the CEO may all see different parts of the company.

A manager may detect a problem early, detect it late, misunderstand it, overreact, or correctly recognize a familiar pattern.

Use evidence and patterns, not just one number.
...
# 16. Crises and Failure

Crises can involve finance, staffing, customers, product quality, operations, leadership, burnout, manufacturing, or investors.
...
Private browsing may not preserve saves.

Starting a new company replaces the current save after confirmation.
...
- Maintain enough staffing for active projects.

## Launch

- Do not judge readiness from progress alone.
- Review quality, integration, customers, manufacturing, trust, and staffing.
- Consider a pilot when uncertainty is high.

## Long Term

- Watch trends, not only current values.
- Preserve employee experience.
- Avoid relying on one product, customer, or employee.
- Read Department Briefings and Story Threads.
- Use past outcomes to guide future decisions.
- Keep enough cash to recover from mistakes.
...
- most problems are handled locally
- messages may be incomplete or wrong
- the same decision can produce different results
