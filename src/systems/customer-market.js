...
function makeProjectCommercializationEvent(project){
  ...
  return {
    ...
    generatedCommunication:{
      ...
      message:`${project.title} is complete. Product sees customer interest around ${interest}, commercial readiness around ${readiness}, and a projected daily revenue contribution near $${Number(project.projectedDailyRevenue||0).toFixed(3)}M if the launch path works. The CEO needs to decide whether to expose this project to customers, pilot it first, or shelve it.`,
