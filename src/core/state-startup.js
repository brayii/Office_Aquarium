...
ensureBibleSystems?.();rebuildRuntimeIndexes?.();ensureProjectAllocations?.();buildOffice(true);renderDecisionEvent();render();restartTimer();return true;}catch(e){console.warn("Save migration failed",e);return false;}}
