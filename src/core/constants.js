...
globalThis.OFFICE_AQUARIUM_CONSTANTS=deepFreezeConstants({
  ...
  hiring:{
    ...
    requestScoreThreshold:72,
    requestSustainDays:2,
    requestConfidenceThreshold:48,
    minimumRequestMemoGapDays:8,
    ...
    searchExceptionDays:60,
    searchExceptionAttempts:4,
    ...
    recruitingStage:{
      searchingFraction:.34,
      interviewingFraction:.18,
      offerFraction:.09,
      searchingMinDays:3,
      interviewingMinDays:2,
      offerMinDays:1
    },
    offerAcceptance:{
      base:.64,
  ...
  economy:{
    ...
    manufacturingBaseDaily:.018,
    manufacturingCapacityDaily:.00072,
    manufacturingCustomerDaily:.00062,
    manufacturingSupplyPressureDaily:.00030,
    qualityBurdenThreshold:62,
    qualityBurdenDailyRate:.0008,
    supportCustomerDaily:.00052,
    supportLowTrustThreshold:55,
    supportLowTrustDailyRate:.000006,
    growthBaselineHeadcount:8,
    growthOverheadPerEmployeeDaily:.012,
    growthOverheadPerCustomerDaily:.00034,
    launchedGrowthOverheadDaily:.022,
    crisisDailyCost:.006
  },
  portfolioDemand:{
  ...
  projectDevelopment:{
    ...
    expectedWorkItemCycleDays:3.25,
    minimumPlannedWorkItems:34,
    legacyOnboarding:{
      estimatedDurationDays:92,
      deadlineBufferDays:34,
      workItemCycleDays:4.4,
      minimumPlannedWorkItems:140,
      maximumPlannedWorkItems:190,
      backlogMultiplier:.82,
  ...
  customerMarket:{
    ...
    projectRevenue:{
      launchedMultiplier:.72,
      pilotMultiplier:.32
    },
    segmentDefinitions:{
      enterprise:{label:"Enterprise",weight:.30,contractValue:.0058,reliability:1.25,support:1.15,price:.75,roadmap:1.15,switching:68},
      smallBusiness:{label:"Small Business",weight:.26,contractValue:.0021,reliability:.82,support:1.05,price:1.35,roadmap:.78,switching:38},
      education:{label:"Education",weight:.14,contractValue:.0014,reliability:.86,support:.90,price:1.55,roadmap:1.05,switching:47},
      government:{label:"Government",weight:.12,contractValue:.0047,reliability:1.35,support:.95,price:.90,roadmap:1.10,switching:74},
      strategicPartners:{label:"Strategic Partners",weight:.18,contractValue:.0069,reliability:1.08,support:.85,price:.72,roadmap:1.30,switching:62}
    }
  },
  investorRelations:{
    reaction:{
