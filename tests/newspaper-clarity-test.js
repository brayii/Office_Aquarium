...
async function main() {
  ...
  const result = await page.evaluate(() => {
    ...
    company.weeklyEvents = [
      { text: "CEO decision: Approve a validation sprint.", type: "leadership", importance: 5, day: company.day },
      { text: "Decision outcome: Mixed result.", type: "leadership", importance: 4, day: company.day },
